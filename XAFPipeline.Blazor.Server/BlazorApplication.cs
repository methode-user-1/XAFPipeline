...
namespace XAFPipeline.Blazor.Server {
    public partial class XAFPipelineBlazorApplication : BlazorApplication {
        public XAFPipelineBlazorApplication() {
            InitializeComponent();
        }
        ...
        private void XAFPipelineBlazorApplication_DatabaseVersionMismatch(object sender, DatabaseVersionMismatchEventArgs e) {
#if EASYTEST
            e.Updater.Update();
            e.Handled = true;
#else
